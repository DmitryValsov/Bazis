...
namespace Bazis.Data.Migrations
{
    ...
    [Migration("20250526163945_AddOrdersAndUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bazis.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Bazis.Models.Order", b =>
                {
                    b.HasOne("Bazis.Data.ApplicationUser", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bazis.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
